...
TEST_CASE("880. Decoded String at Index") {
  ...
  const auto [name, s, k, expected] = GENERATE(
      ...
      TestCase{.name = "Large string 1", .s = "czjkk9elaqwiz7s6kgvl4gjixan3ky7jfdg3kyop3husw3fm289thisef8blt7a7zr5v5lhxqpntenvxnmlq7l34ay3jaayikjps", .k = 768077956, .expected = "c"},
      TestCase{.name = "Large string 2", .s = "ajx37nyx97niysdrzice4petvcvmcgqn282zicpbx6okybw93vhk782unctdbgmcjmbqn25rorktmu5ig2qn2y4xagtru2nehmsp", .k = 976159153, .expected = "a"});
